...
const Professionals = () => {
  ...
  return <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {mockProfessionals.map(professional => <Card key={professional.id} className="hover-lift">
            <CardHeader>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-1">
                  {professional.specialties.map((specialty, index) => <Badge key={index} variant="outline" className="text-xs">
                      {specialty}
                    </Badge>)}
                </div>
              </div>
